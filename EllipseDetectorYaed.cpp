...
void CEllipseDetectorYaed::GetFastCenter	(	vector<Point>& e1,
												vector<Point>& e2,
												EllipseData& data
											)
{
...
void CEllipseDetectorYaed::DetectEdges13	(	Mat1b& DP,
												VVP& points_1,
												VVP& points_3
											)
{
...
void CEllipseDetectorYaed::DetectEdges24	(	Mat1b& DN,
												VVP& points_2,
												VVP& points_4
											)
{
...
void CEllipseDetectorYaed::DetectAfterPreProcessing(vector<CEllipse>& ellipses, Mat1b& E, const Mat1f& PHI)
{
	// set the image size
	_szImg = E.size();
...
void CEllipseDetectorYaed::Detect	(	Mat1b& I,
										vector<CEllipse>& ellipses
									)
{
	// set the image size
...
void CEllipseDetectorYaed::ClusterEllipses(vector<CEllipse>& ellipses)
{	
...
void CEllipseDetectorYaed::DrawDetectedEllipses(Mat3b& output, vector<CEllipse>& ellipses, int iTopN, int thickness)
{	
